...
define('ROOT', '/');
define('APP', ROOT.'Grievance');
define('UPLOAD_IMAGE_PATH', HTTP_HOST . 'media/images/uploads/');
define('STATIC_IMAGE_PATH', HTTP_HOST . 'media/images/static/');
...
//define('JTI', base64_encode(mcrypt_create_iv(32, MCRYPT_DEV_RANDOM)));
...
define('UN_AUTHORIZED_ACCESS', 401);
...
define('DBPASSWORD', 'WebmAstEr@#2016'); 
